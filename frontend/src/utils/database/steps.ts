...
// - GET /api/experts              列出环节 + 各自的 loop 引用计数
// - GET /api/experts/candidates   loop 编辑器选环节用的精简候选
// - GET /api/experts/:id          单个环节详情 + 引用计数
