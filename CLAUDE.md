...
2. **确认方案** — 向人类说明设计方案，获确认后再编码
3. **编写文档** — 先在 `docs/design/` 创建设计文档，如涉及新功能需有对应需求文档
4. **编写代码** — 遵循注释、函数长度、测试、零告警等规范
5. **编译+测试** — `cargo clippy -- -D warnings` + `cargo test`
6. **安全反思** — 检查逻辑漏洞、越权风险、输入校验
7. **功能总结** — 在 `docs/requirements/` 创建实现总结文档
8. **提交 PR** — 创建 PR 并说明与需求的对应关系
